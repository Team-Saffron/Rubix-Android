...
label0:
    ...
    {
        ProgressBarCompat progressbarcompat = (ProgressBarCompat)mActivity.findViewById(android.support.v7.appcompat.R.id.progress_circular);
    ...
    {
        ProgressBarCompat progressbarcompat = (ProgressBarCompat)mActivity.findViewById(android.support.v7.appcompat.R.id.progress_horizontal);
        if (progressbarcompat != null)
        {
            progressbarcompat.setVisibility(4);
        }
...
label0:
    ...
    private void hideProgressBars(ProgressBarCompat progressbarcompat, ProgressBarCompat progressbarcompat1)
    {
        if (mFeatureIndeterminateProgress && progressbarcompat1.getVisibility() == 0)
        {
            progressbarcompat1.setVisibility(4);
        }
        if (mFeatureProgress && progressbarcompat.getVisibility() == 0)
        {
            progressbarcompat.setVisibility(4);
        }
    }
...
_L3:
    ...
    private void showProgressBars(ProgressBarCompat progressbarcompat, ProgressBarCompat progressbarcompat1)
    {
        if (mFeatureIndeterminateProgress && progressbarcompat1.getVisibility() == 4)
        {
            progressbarcompat1.setVisibility(0);
        }
        if (mFeatureProgress && progressbarcompat.getProgress() < 10000)
        {
    ...
    private void updateProgressBars(int i)
    {
        ...
        ProgressBarCompat progressbarcompat1;
        progressbarcompat = getCircularProgressBar();
        progressbarcompat1 = getHorizontalProgressBar();
        if (i != -1) goto _L2; else goto _L1
_L1:
        if (mFeatureProgress)
        {
            i = progressbarcompat1.getProgress();
            if (progressbarcompat1.isIndeterminate() || i < 10000)
            {
                i = 0;
            } else
            {
            ...
            progressbarcompat1.setVisibility(i);
        }
...
_L2:
        ...
        if (mFeatureProgress)
        {
            progressbarcompat1.setVisibility(8);
        }
        if (mFeatureIndeterminateProgress)
        {
...
_L3:
        if (i == -3)
        {
            progressbarcompat1.setIndeterminate(true);
            return;
        }
        if (i == -4)
        {
            progressbarcompat1.setIndeterminate(false);
            return;
        }
        if (i >= 0 && i <= 10000)
        {
            progressbarcompat1.setProgress(i + 0);
            if (i < 10000)
            {
                showProgressBars(progressbarcompat1, progressbarcompat);
                return;
            } else
            {
                hideProgressBars(progressbarcompat1, progressbarcompat);
                return;
            }
        }
...
_L5:
    ...
    View createView(String s, AttributeSet attributeset)
    {
...
_L4:
        if (s.equals("CheckedTextView"))
        {
          ...
          goto _L3
_L9:
        return new TintEditText(mActivity, attributeset);
_L10:
        return new TintSpinner(mActivity, attributeset);
_L11:
        return new TintCheckBox(mActivity, attributeset);
_L12:
        return new TintRadioButton(mActivity, attributeset);
_L13:
        return new TintCheckedTextView(mActivity, attributeset);
    }
