...
abstract class ActionBarActivityDelegate
{
    ...
    abstract View createView(String s, AttributeSet attributeset);
    ...
    void onCreate(Bundle bundle)
    {
        ...
        {
            mHasActionBar = bundle.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowActionBar, false);
            mOverlayActionBar = bundle.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowActionBarOverlay, false);
            mOverlayActionMode = bundle.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowActionModeOverlay, false);
