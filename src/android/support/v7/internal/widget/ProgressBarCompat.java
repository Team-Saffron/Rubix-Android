...
public class ProgressBarCompat extends View
{
    ...
    public ProgressBarCompat(Context context, AttributeSet attributeset, int i, int j)
    {
        boolean flag = false;
...
/*
    static RefreshProgressRunnable access$102(ProgressBarCompat progressbarcompat, RefreshProgressRunnable refreshprogressrunnable)
    {
        progressbarcompat.mRefreshProgressRunnable = refreshprogressrunnable;
